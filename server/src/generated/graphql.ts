...
export type MutationUpdateTitleArgs = {
  conId: Scalars['Int'],
  conTitle?: Maybe<Scalars['String']>
};

export type Query = {
   __typename?: 'Query',
  User?: Maybe<Array<Maybe<User>>>,
  Feed?: Maybe<Array<Maybe<UserFeed>>>,
};
...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  ...
  updateTitle?: Resolver<Maybe<ResolversTypes['UserFeed']>, ParentType, ContextType, RequireFields<MutationUpdateTitleArgs, 'conId'>>,
};

export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  User?: Resolver<Maybe<Array<Maybe<ResolversTypes['User']>>>, ParentType, ContextType>,
  Feed?: Resolver<Maybe<Array<Maybe<ResolversTypes['UserFeed']>>>, ParentType, ContextType>,
};
